const GAMES = [
  ...
  },
  {
    ...
    "prompts": {
      "desc": "Unusual area of expertise for the expert — choose ones that naturally invite physical demonstration",
      "beginner": [
        "A cooking expert demonstrating the correct way to make the perfect sandwich",
        "A fitness instructor explaining the perfect push-up technique",
        "A magician revealing (badly) how a card trick works",
        "A hairdresser demonstrating the latest trending haircut",
        "A football coach demonstrating the perfect goal celebration",
        "A barista explaining how to make the ultimate hot chocolate",
        "A dance instructor breaking down a viral dance move",
        "A driving instructor explaining how to parallel park",
        "A gardener demonstrating the correct way to plant a seedling",
        "A dog trainer showing off their prize-winning tricks"
      ],
      "intermediate": [
        "A world-renowned sushi chef explaining the art of rolling the perfect roll",
        "A professional wrestler demonstrating their signature move",
        "A yoga instructor guiding the class through an advanced pose",
        "A tightrope walker explaining the secret to perfect balance",
        "A sign language interpreter teaching everyday phrases",
        "A mime artist explaining the techniques behind their craft",
        "A martial arts grandmaster demonstrating a powerful self-defence move",
        "An orchestra conductor explaining how to lead a symphony",
        "A puppeteer demonstrating how to bring a puppet to life",
        "A tailor explaining the precise art of measuring a customer for a suit"
      ],
      "advanced": [
        "A world champion sommelier demonstrating the art of swirling and tasting wine",
        "A surgeon calmly talking through (and demonstrating) a delicate procedure",
        "A bomb disposal expert walking through the defusing process with total composure",
        "A renowned conductor demonstrating the subtlest gestures that control an entire orchestra",
        "A forensic pathologist demonstrating precise examination techniques",
        "A hostage negotiator explaining the calming hand gestures used in high-stress situations",
        "A celebrated sculptor demonstrating how they shape clay into a masterpiece",
        "A professional poker player explaining the art of the perfectly disguised \"tell\"",
        "A renowned chef demonstrating an elaborate flambé technique tableside",
        "A master watchmaker demonstrating the delicate art of assembling tiny gears"
      ]
    },
    "variations": [
